...
{
    public class FreezeAccountHandlerTest
    {
        ...
        public FreezeAccountHandlerTest()
        {
            _mockRepository = new Mock<IAccountRepository>();
            _mockWork = new Mock<IUnitOfWork>();
            _handler = new FreezeAccountCommandHandler(_mockRepository.Object, _mockWork.Object, NullLogger<FreezeAccountCommandHandler>.Instance);
        }
        ...
        public async Task Should_Return_True_If_Activated()
        {
            ...
            // Assert
            Assert.True(account.Status == Domain.Enums.AccountStatus.Frozen);
